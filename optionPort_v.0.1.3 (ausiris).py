...
simulatedPrice = np.linspace(1000, 1400, points) #coulndt be 0

#=====================================FILE LOAD======================================#

brokerTxt = 'ausiris_4Q2018.txt'


with open(brokerTxt, 'r') as input, open('ausiris_4Q2018.csv','w') as output:
